<template>
    <section class="container">
        ...
        <div v-if="mostrarDatosUsuario">
            <p class="title is-4 has-text-weight-bold">
            Bienvenido por favor recarga la pagina y recuerda las credenciales por defecto que te fueron proporcionadas
            <img src="@/assets/guia.png" alt="Pasos de inicio de sesion">
            </p>
