      ...
      <div class="column is-one third">
        <div class="card">
          <header class="card-header">
            ...
            <span class="tag is-primary is-large is-pulled-right" style="background-color: orange;">
              {{ totalVentasSemana }}Bs.</span
            >
          </header>
